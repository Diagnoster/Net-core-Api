...
namespace SmartSchool.WebAPI.Data
{
    public class SmartContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder) {
            ...
            builder.Entity<AlunoDisciplina>() // cria um muito para muitos
                .HasKey(AD => new {AD.AlunoId, AD.DisciplinaId});

            builder.Entity<Professor>() // cargas iniciais tabela
                .HasData(new List<Professor>(){ // has data -> tem dados
                    new Professor(1, "Lauro"),
                    new Professor(2, "Roberto"), // cria os dados
